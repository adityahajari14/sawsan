    ...
    <section className="w-full bg-white px-4 md:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 md:mb-16 lg:mb-20">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-300 blur-[1px] mb-8">
            Why This Matters
          </h2>
          <Link
            href="#"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 lg:pl-8">
            <p className="text-3xl md:text-4xl lg:text-5xl leading-relaxed text-gray-300 font-light blur-[0.8px]">
